      ...
      <v-list three-line subheader>
        ...
        <v-container>
          <v-row dense>
            ...
            <v-col
              cols="4"
              v-for="result in undetectedResults"
            ...
            >
              <v-card>
                <v-list-item three-line>
                  ...
                  <v-list-item-avatar tile size="30" color="green accent-3">
                    <!-- undetected -->
                    <svg
            ...
            <!-- type-unsupported || failure || timeout -->
            <v-col
              cols="4"
              v-for="result in unsureResults"
              v-bind:key="result.engine_name"
            >
              <v-card>
                <v-list-item three-line>
                  ...
                  <v-list-item-avatar tile size="30" color="grey lighten-1">
            ...
            <!-- others | (malicious maybe) -->
            <v-col
              cols="4"
              v-for="result in maliciousResults"
              v-bind:key="result.engine_name"
            >
              <v-card>
                <v-list-item three-line>
                  ...
                  <v-list-item-avatar tile size="30" color="red accent-1">
                    <!-- something else, malicious maybe -->
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="#ffffff"
  ...
  computed: {
    undetectedResults() {
      return this.data.filter((result) => {
        return result.category === 'undetected'
      })
    },
    unsureResults() {
      return this.data.filter((result) => {
